 ...
 *  Authors: Patrick Garcia, Christopher Goodell, Seth Harpold, Josue Perez 
 *  Class: EENG 6303
...
float sensor1Impact = 0;
float sensor2Impact = 0;
float sensor3Impact = 0;

//Sensor Baseline values converted
float baseA = 87555.0;
...
void impactDetect(void)
{
  ...
  long sensorValue2;
  long sensorValue3;
  if (sensor1.is_ready() && sensor2.is_ready() && sensor3.is_ready() && !impactDetected) 
  {
    //Read Sensors
